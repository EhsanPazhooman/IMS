...
public class SearchProductTransactionUseCase : ISearchProductTransactionUseCase
{
    ...
    public async Task<IEnumerable<ProductTransaction>> ExecuteAsync(string productName, DateTime? dateFrom, DateTime? dateTo,
        ProductTransactionType? productTransactionType)
    {
        ...
        return await _productTransactionRepository.GetProductTransactionAsync(
            productName, dateFrom, dateTo, productTransactionType);
    }
}